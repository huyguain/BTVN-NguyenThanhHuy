...
public class J2Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (calculation) {
            case "sum":
                result = J2DAO.calculateSum(first, second);
                break;
            case "sub":
                result = J2DAO.calculateSub(first, second);
                break;
            case "mul":
                result = J2DAO.calculateMulti(first, second);
                break;
            case "div":
                result = J2DAO.calculateDiv(first, second);
        }
